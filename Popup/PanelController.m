...
#define POPUP_HEIGHT 442
#define PANEL_WIDTH 354
...
- (IBAction)contact:(NSButton *)sender {
}
...
//Social networking "picture" links

//Vimeo
- (IBAction)vimeo:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://vimeo.com/user12814665"]];
}
//Dribbble
- (IBAction)dribbble:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://dribbble.com/nerd"]];
}
//My website (thedunahoos.com)
- (IBAction)website:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://thedunahoos.com"]];
}
//A link to my artist portfolio on the Mac App Store
- (IBAction)mas:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://itunes.apple.com/us/artist/bread-butter-software-llc./id323248486?mt=12"]];
}
